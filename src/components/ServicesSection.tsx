...
const ServicesSection = () => {
  return (
    <section id="services" className="py-16 sm:py-20 md:py-24 bg-cream">
          ...
          <div className="bg-card rounded-2xl sm:rounded-3xl shadow-lg shadow-primary/5 overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-primary/10">
              {services.map((service) => (
                <div
                  key={service.title}
                  className="group p-6 sm:p-8 md:p-6 lg:p-10 flex flex-col items-center text-center transition-all duration-300 hover:bg-secondary/30"
                >
                  {/* Icon */}
                  <div className="w-12 sm:w-14 md:w-14 lg:w-16 h-12 sm:h-14 md:h-14 lg:h-16 bg-secondary rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-5 md:mb-6 group-hover:scale-110 transition-transform duration-300">
                    <service.icon className="w-6 sm:w-7 md:w-7 lg:w-8 h-6 sm:h-7 md:h-7 lg:h-8 text-primary/70" />
                  </div>
