    ...
    <section className="py-16 sm:py-20 md:py-24 bg-cream">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-10 sm:mb-12 md:mb-16">
          <span className="text-primary/60 text-xs sm:text-sm font-semibold uppercase tracking-wider mb-2 sm:mb-4 block">
            Why Choose Us
          </span>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-5 md:gap-6">
          {/* Large Feature Card */}
          <div className="sm:col-span-2 md:col-span-2 bg-primary rounded-2xl sm:rounded-3xl p-5 sm:p-6 md:p-8 text-cream group hover:shadow-2xl hover:shadow-primary/20 transition-all duration-500">
            ...
            <p className="text-cream/70 text-sm sm:text-base mb-6 sm:mb-8 max-w-md">
              From compact Mavics to heavy-lift cinematography platforms — equipment for every mission profile.
            </p>
            <a
              href="#portfolio"
              className="inline-flex items-center gap-2 text-cream font-semibold text-sm sm:text-base group/link"
            >
              View Fleet
          ...
          {/* Small Feature Card */}
          <div className="bg-card rounded-2xl sm:rounded-3xl p-5 sm:p-6 md:p-8 flex flex-col justify-between hover:shadow-xl hover:shadow-primary/10 transition-all duration-500">
          ...
          {features.slice(0, 3).map((feature, index) => (
            <div
              key={feature.title}
              className={`rounded-2xl sm:rounded-3xl p-5 sm:p-6 md:p-8 transition-all duration-500 hover:shadow-xl ${
                feature.highlight
